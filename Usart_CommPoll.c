/**
 * \author Mr.Nobody
 * \file Usart_CommPoll.h
 * \ingroup Usart
 * \brief CommPoll module common functionality
 *
 */
/* ============================== INCLUDES ================================== */
#include "Usart_CommPoll.h"                    /* Self include                   */
 ...
 */
usart_ModuleVersion_t Usart_CommPoll_Get_ModuleVersion( void )
{
...
/**
 * \brief Initializes module CommPoll
 *
...
/**
 * \brief Deinitializes module CommPoll
 *
 ...
 * layer.
 */
void Usart_CommPoll_Deinit( void )
{
